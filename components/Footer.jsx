    ...
    <div>
      <footer className="flex justify-center px-4 text-gray-100 bg-gray-800">
        <div className="container py-5">
          ...
          <div className="flex justify-center mt-6">
            <div className="bg-white rounded-lg">
              <div className="flex flex-wrap justify-between md:flex-row">
                ...
                <button
                  type="submit"
                  className="w-full m-1 p-2 text-sm bg-red-800 rounded-lg font-semibold uppercase lg:w-auto"
                >
                  subscribe
                </button>
              </div>
          ...
          <p className="mt-3 text-center text-lg text-black font-bold bg-white">
